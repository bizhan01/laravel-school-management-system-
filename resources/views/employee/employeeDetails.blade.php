          ...
          <div class="tab-content">
            <div class="tab-pane active" id="main-address" role="tabpanel">
              <div class="media stream-item">
                ...
                <div class="media-body">
                  <h6 class="media-heading">ولایت اصلی</h6>
              ...
              <div class="media stream-item">
                ...
                <div class="media-body">
                  <h6 class="media-heading">ولسوالی اصلی</h6>
                  <div class="stream-body">
                    <a href="img/1.html">
              ...
              <div class="media stream-item">
                ...
                <div class="media-body">
                  <h6 class="media-heading">ناحیه / قریه اصلی</h6>
                  <div class="stream-body">
            ...
            <div class="tab-pane" id="current-address" role="tabpanel">
              <div class="media stream-item">
                ...
                <div class="media-body">
                  <h6 class="media-heading">ولایت فعلی</h6>
                  <div class="stream-body">
              ...
              <div class="media stream-item">
                ...
                <div class="media-body">
                  <h6 class="media-heading">ولسوالی فعلی</h6>
                  <div class="stream-body">
                    <a href="img/1.html">
                      <img class="stream-img" src="img/photos-1/2.jpg" alt="">
                    </a>
              ...
              <div class="media stream-item">
                ...
                <div class="media-body">
                  <h6 class="media-heading">ناحیه / قریه فعلی</h6>
                  <div class="stream-body">
