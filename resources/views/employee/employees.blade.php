          ...
          <table class="table table-bordered table-striped" id="table-3">
            <thead>
               <tr>
                  ...
                  <th data-priority="6">بروزسازی</th>
            ...
            <tbody>
              @foreach($employees as $employee)
               <tr>
                  ...
                  <td><a href="{{ URL::to('employees/' . $employee->id . '/edit') }}" ><li class="fa fa-edit text-success"></li></a></td>
                  <td><a href="{{ url('employeeDetails').'/'.$employee->id}}" ><li class="fa fa-info text-info"></li></a></td>
                  <td>
