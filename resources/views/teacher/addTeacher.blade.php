				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control txt" name="f_name" required>
							<span class="font-90 text-muted"></span>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="address" class="form-control txt" name="main_address" placeholder="ولایت/ولسوالی/ناحیه یا قریه" required>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="address" class="form-control txt" name="current_address" placeholder="ولایت/ولسوالی/ناحیه یا قریه" required>
							<span class="font-90 text-muted"></span>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="number" class="form-control" name="tazkira_no" required>
							<span class="font-90 text-muted pull-left" ></span>
						</div>
					</div>
				</div>
